// app/projeler/[id]/duzenle/page.tsx
'use client'
...
export default function ProjeDuzenle() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (updateError) {
      ...
      router.push('/projeler/' + id) // Detay sayfasına geri dön
      router.refresh()
    }
    ...
    <div className="min-h-screen bg-gray-900 text-gray-100 py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="bg-gray-800 border border-gray-700 rounded-xl p-8 shadow-lg space-y-8">
          ...
          {error && (
            <div className="bg-red-500/10 text-red-400 p-4 rounded-lg flex items-center gap-3 text-sm border border-red-500/20">
          ...
          <button
            ...
            className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 rounded-lg transition disabled:opacity-50 flex items-center justify-center gap-2"
          >
